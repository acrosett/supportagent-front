(function(){const L={width:"400px",height:"600px",domain:window.location.origin,position:"bottom-right",zIndex:1E3},F={robot:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" aria-hidden="true" focusable="false">\x3c!--!Font Awesome Free v7.0.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--\x3e<path d="M352 64C352 46.3 337.7 32 320 32C302.3 32 288 46.3 288 64L288 128L192 128C139 128 96 171 96 224L96 448C96 501 139 544 192 544L448 544C501 544 544 501 544 448L544 224C544 171 501 128 448 128L352 128L352 64zM160 432C160 418.7 170.7 408 184 408L216 408C229.3 408 240 418.7 240 432C240 445.3 229.3 456 216 456L184 456C170.7 456 160 445.3 160 432zM280 432C280 418.7 290.7 408 304 408L336 408C349.3 408 360 418.7 360 432C360 445.3 349.3 456 336 456L304 456C290.7 456 280 445.3 280 432zM400 432C400 418.7 410.7 408 424 408L456 408C469.3 408 480 418.7 480 432C480 445.3 469.3 456 456 456L424 456C410.7 456 400 445.3 400 432zM224 240C250.5 240 272 261.5 272 288C272 314.5 250.5 336 224 336C197.5 336 176 314.5 176 288C176 261.5 197.5 240 224 240zM368 288C368 261.5 389.5 240 416 240C442.5 240 464 261.5 464 288C464 314.5 442.5 336 416 336C389.5 336 368 314.5 368 288zM64 288C64 270.3 49.7 256 32 256C14.3 256 0 270.3 0 288L0 384C0 401.7 14.3 416 32 416C49.7 416 64 401.7 64 384L64 288zM608 256C590.3 256 576 270.3 576 288L576 384C576 401.7 590.3 416 608 416C625.7 416 640 401.7 640 384L640 288C640 270.3 625.7 256 608 256z"/></svg>',
...
return}R(b.windowStore||"AISupportWidget");var {container:c,iframe:r}=N(b);document.body.appendChild(c);var e=null,q=!1,v=()=>{if(!q){var d=window.innerWidth,n=window.innerHeight;if(!(d>768)){var h=Math.floor(d*.96),l=Math.floor(n*.98);c.style.maxWidth=h+"px";c.style.maxHeight=l+"px";var m=c.getBoundingClientRect();m.width>h&&(c.style.width=h+"px");m.height>l&&(c.style.height=l+"px");h=c.getBoundingClientRect();l=h.left;m=h.top;var t=!1;l+h.width>d-4&&(l=Math.max(4,d-h.width-4),t=!0);m+h.height>n-
4&&(m=Math.max(4,n-h.height-4),t=!0);l<4&&(l=4,t=!0);m<4&&(m=4,t=!0);t&&(c.style.left=l+"px",c.style.top=m+"px",c.style.right="auto",c.style.bottom="auto")}}},w=()=>{if(e)return e;var d=b.primaryColor||"#764ba2";const n=b.secondaryColor||d,h=F[b.icon]||F.robot;e=document.createElement("div");e.id="ai-support-widget-bubble";e.setAttribute("role","button");e.setAttribute("aria-label","Open chat support");e.style.cssText=`position:fixed; ${J(b.position)} width:${72}px; height:${72}px; border-radius:50%; background:linear-gradient(135deg, ${d} 0%, ${n} 100%); box-shadow:0 4px 8px rgba(0,0,0,.20),0 10px 30px rgba(0,0,0,.35),0 0 0 1px rgba(255,255,255,.15) inset; display:none; align-items:center; justify-content:center; cursor:pointer; z-index:${(b.zIndex||
...
K):K().catch(a=>{console.error("AI Support Widget initialization failed:",a)})})();
